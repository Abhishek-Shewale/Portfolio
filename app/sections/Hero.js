      ...
      <div className="container mx-auto px-4 relative z-10 py-8">
        ...
        >
          ...
          <motion.div
            ...
            className="mb-8"
          >
            <div className="w-28 h-28 bg-gradient-to-r from-orange-600 to-orange-400 rounded-full mx-auto p-1">
              <div className="w-full h-full relative rounded-full overflow-hidden">
                <Image
                  src="/abhishek.png"
                  alt="Abhishek Shewale"
                  fill
          ...
          >
            Full Stack Engineer crafting scalable web applications with modern
            technologies. Get the perfect showcase of your skills with the right
