  ...
  const contactInfo = [
    {
      type: "email",
      label: "Email",
      value: "abhishewale100@gmail.com",
      icon: (
        <svg
          className="w-6 h-6"
          fill="none"
      ...
      action: () => window.open("abhishewale100@gmail.com"),
    },
    {
      type: "phone",
      label: "Phone",
      ...
      action: () => window.open("tel:+919623501027"),
    },
    
    {
      type: "linkedin",
      label: "LinkedIn",
      value: "Abhishek Shewale",
      icon: (
        <svg
          className="w-6 h-6"
          fill="currentColor"
      ...
      action: () =>
        window.open("https://www.linkedin.com/in/abhishekshewale/", "_blank"),
    },
    {
      type: "github",
      label: "GitHub",
      ...
      action: () =>
        window.open("https://github.com/Abhishek-Shewale", "_blank"),
    },
    {
      type: "location",
      label: "Location",
