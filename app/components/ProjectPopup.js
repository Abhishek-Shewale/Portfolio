...
const ProjectPopup = ({ isOpen, onClose }) => {
  const projects = [
    {
      title: "InterviewBabu",
      description: "AI-powered voice mock interview platform serving 2K+ users with real-time speech recognition, reducing preparation time by 40%. Resume parsing using AI vision to extract user data and generate tailored questions.",
      techStack: [
        { name: "Next.js", icon: Layout, color: "#000000" },
        { name: "Google Gemini AI", icon: Brain, color: "#4285F4" },
        { name: "Firebase", icon: Flame, color: "#FFA611" },
        { name: "Web Speech API", icon: Mic, color: "#61DAFB" },
        { name: "Text-To-Speech", icon: Volume2, color: "#4B32C3" }
      ],
      livePreview: "https://interviewbabu.com/login",
      image: "/interviewbabu.png",
      featured: true
    },
    {
      title: "HealthBooker",
      description: "Healthcare platform for appointment booking and doctor applications with intuitive user interface, reducing booking time by 65%. Dynamic profile management allowing users to personalize profiles with medical history and preferences.",
      techStack: [
      ...
      livePreview: "https://healthbooker-d9if.onrender.com",
      github: "https://github.com/Abhishek-Shewale/HealthBooker",
      image: "/healthbooker.png"
    },
    {
      title: "Scrap Mart",
      description: "E-commerce platform built with MERN stack for buying and selling scrap materials. Features intuitive user interface, dynamic product management, and seamless transaction handling.",
      techStack: [
        { name: "MongoDB", icon: Database, color: "#47A248" },
        { name: "Express", icon: Server, color: "#000000" },
        { name: "React", icon: Code2, color: "#61DAFB" },
      ...
      livePreview: "https://scrap-mart-pink.vercel.app/",
      github: "https://github.com/Abhishek-Shewale/scrap-mart",
      image: "/scrapmart.png"
    }
  ];
